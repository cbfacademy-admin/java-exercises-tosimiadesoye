...
public class Bank {
     ...
     */
    public Account opeAccount(double balance, String accountType) {
        ...
        switch (accountType.toLowerCase()) {
            ...
            case "basic":
                ...
                break;
            case "savings":
                account = new SavingAccount(accountNumber, balance, interestRate);// You can set the interest rate as
                break;
            case "current":
     ...
     */
    public void sendOverdraftLetter(long accountId) {
